...
public class pirateboss_convertedtoAJ<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "pirateboss_convertedtoaj"), "main");
	...
	public pirateboss_convertedtoAJ(ModelPart root) {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		theguyhimself.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
